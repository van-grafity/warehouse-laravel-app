        ...
        <div class="card-tools ml-auto p-3">
            <div class="btn-group">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="<?= url_to('packinglist-show',$packinglist->id) ?>">Packinglist</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="<?= url_to('fabric-offloading-detail',$packinglist->id) ?>">Fabric Offloading</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="<?= url_to('fabric-stock-in-detail',$packinglist->id) ?>">Fabric Stock in</a>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <dl class="row">
                            ...
                            <dd class="col-md-8 col-sm-12" id="invoice"> <?= $packinglist->invoice ?> </dd>
                    ...
                    <div class="col-sm-7">
                        <dl class="row">
                            ...
                            <dd class="col-md-8 col-sm-12" id="color"> <?= $packinglist->color ?> (<?= $packinglist->color_code ?>) </dd>
                    ...
                    <div class="card-body p-0">
                        <table class="table table-sm text-center align-middle" id="roll_summary_table">
                            ...
                            <tbody>
                                ...
                                <?php else : ?>
                                <?php foreach ($roll_summary as $key => $roll) { ?>
                                <tr>
